    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={5666930893}"
                ...
                signed_api = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={5666930893}"
            ...
            if "jw-prod" in url:
               ...
               cmd = f'yt-dlp --add-header "referer:https://web.classplusapp.com/" --add-header "x-cdn-tag:empty" -f "{ytf}" "{url}" -o "{name}.mp4"'
                ...
                cmd = f'yt-dlp -f "{ytf}" "{url}" --allow-unplayable-formats --no-warnings -o "{name}.mp4"'
